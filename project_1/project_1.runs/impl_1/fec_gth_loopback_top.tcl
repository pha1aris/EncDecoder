namespace eval ::optrace {
  variable script "C:/Users/PC/Desktop/fps/EnDec/project_1/project_1.runs/impl_1/fec_gth_loopback_top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Users/PC/Desktop/fps/EnDec/project_1/project_1.runs/synth_1/fec_gth_loopback_top.dcp
...
OPTRACE "link_design" START { }
  link_design -top fec_gth_loopback_top -part xczu15eg-ffvb1156-2-i 
...
OPTRACE "opt_design reports" START { REPORT }
  ...
  generate_parallel_reports -reports { "report_drc -file fec_gth_loopback_top_drc_opted.rpt -pb fec_gth_loopback_top_drc_opted.pb -rpx fec_gth_loopback_top_drc_opted.rpx"  }
  set_param project.isImplRun false
OPTRACE "opt_design reports" END { }
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fec_gth_loopback_top_opt.dcp
...
OPTRACE "place_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_io -file fec_gth_loopback_top_io_placed.rpt" "report_utilization -file fec_gth_loopback_top_utilization_placed.rpt -pb fec_gth_loopback_top_utilization_placed.pb" "report_control_sets -verbose -file fec_gth_loopback_top_control_sets_placed.rpt"  }
  set_param project.isImplRun false
OPTRACE "place_design reports" END { }
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fec_gth_loopback_top_placed.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fec_gth_loopback_top_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file fec_gth_loopback_top_drc_routed.rpt -pb fec_gth_loopback_top_drc_routed.pb -rpx fec_gth_loopback_top_drc_routed.rpx" "report_methodology -file fec_gth_loopback_top_methodology_drc_routed.rpt -pb fec_gth_loopback_top_methodology_drc_routed.pb -rpx fec_gth_loopback_top_methodology_drc_routed.rpx" "report_power -file fec_gth_loopback_top_power_routed.rpt -pb fec_gth_loopback_top_power_summary_routed.pb -rpx fec_gth_loopback_top_power_routed.rpx" "report_route_status -file fec_gth_loopback_top_route_status.rpt -pb fec_gth_loopback_top_route_status.pb" "report_timing_summary -max_paths 10 -report_unconstrained -file fec_gth_loopback_top_timing_summary_routed.rpt -pb fec_gth_loopback_top_timing_summary_routed.pb -rpx fec_gth_loopback_top_timing_summary_routed.rpx -warn_on_violation " "report_incremental_reuse -file fec_gth_loopback_top_incremental_reuse_routed.rpt" "report_clock_utilization -file fec_gth_loopback_top_clock_utilization_routed.rpt" "report_bus_skew -warn_on_violation -file fec_gth_loopback_top_bus_skew_routed.rpt -pb fec_gth_loopback_top_bus_skew_routed.pb -rpx fec_gth_loopback_top_bus_skew_routed.rpx"  }
  set_param project.isImplRun false
OPTRACE "route_design reports" END { }
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fec_gth_loopback_top_routed.dcp
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force fec_gth_loopback_top_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi fec_gth_loopback_top.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force fec_gth_loopback_top.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force fec_gth_loopback_top}
  catch {file copy -force fec_gth_loopback_top.ltx debug_nets.ltx}
