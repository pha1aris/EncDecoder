...
(* HW_HANDOFF = "ddr4_0_microblaze_mcs.hwdef" *) (* core_generation_info = "bd_9054,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_9054,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) 
module bd_9054
   (Clk,
    IO_addr_strobe,
    IO_address,
