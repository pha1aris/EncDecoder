...
vlog -work xpm  -incr -mfcu  -sv -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_19 -L xilinx_vip "+incdir+../../../../project_1.gen/sources_1/ip/ila_rs_backend/hdl/verilog" "+incdir+D:/2024_2/Vivado/2024.2/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../project_1.gen/sources_1/ip/ila_rs_backend/hdl/verilog" "+incdir+D:/2024_2/Vivado/2024.2/data/xilinx_vip/include" \
