...
vlog -work xpm  -l axi_vip_v1_1_19 -l smartconnect_v1_0 -l zynq_ultra_ps_e_vip_v1_0_19 "+incdir+../../../../project_1.gen/sources_1/ip/vio_frame_cfg/hdl/verilog" "+incdir+../../../../project_1.gen/sources_1/ip/vio_frame_cfg/hdl" "+incdir+D:/2024_2/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../project_1.gen/sources_1/ip/vio_frame_cfg/hdl/verilog" "+incdir+../../../../project_1.gen/sources_1/ip/vio_frame_cfg/hdl" "+incdir+D:/2024_2/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
