...
(
    ...
    input  wire        tx_data_valid, // 只是用来选择 idle 还是有效数据
    ...
    assign gtwiz_reset_clk_freerun_in = clk_freerun;   
    assign gtwiz_reset_all_in         = ~rst_n;     
    ...
    assign rxcdrhold_in = 1'b0;    
    assign rxlpmen_in   = 1'b1;    // 低功耗均衡打开
