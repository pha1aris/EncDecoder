...
rxprogdivreset_out_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000E0000"
    )
        port map (
...
\FSM_sequential_sm_reset_rx[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00FF007500000075"
    )
        port map (
      I0 => Q(0),
      I1 => \FSM_sequential_sm_reset_rx_reg[0]_0\,
      I2 => sm_reset_rx_pll_timer_sat,
      I3 => Q(1),
      I4 => Q(2),
      I5 => \^i_in_out_reg_0\,
...
\FSM_sequential_sm_reset_tx[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => Q(1),
      I4 => Q(2),
      I5 => \FSM_sequential_sm_reset_tx_reg[0]_2\,
      O => E(0)
    );
...
\FSM_sequential_sm_reset_rx[2]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => Q(0),
      I5 => \FSM_sequential_sm_reset_rx_reg[0]_2\,
      O => \FSM_sequential_sm_reset_rx_reg[2]\
    );
gtwiz_reset_rx_done_int_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F7FFFFFF55000000"
    )
        port map (
...
gttxreset_out_i_1: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => \gen_gtwizard_gthe4.gttxreset_int\,
      O => \FSM_sequential_sm_reset_tx_reg[0]\
    );
...
gtwiz_reset_tx_done_int_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => Q(0),
      I1 => \^plllock_tx_sync\,
      I2 => gtwiz_reset_tx_done_int_reg_1,
      I3 => sm_reset_tx_timer_sat,
...
gtwiz_reset_tx_done_int_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000022000F000000"
    )
        port map (
      I0 => \gen_gtwizard_gthe4.gen_reset_controller_internal.gen_single_instance.txresetdone_sync\,
      I1 => gtwiz_reset_tx_done_int_reg_2,
      I2 => \^plllock_tx_sync\,
      I3 => Q(2),
      I4 => Q(1),
      I5 => Q(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_gtwiz_reset is
  ...
  signal gtrxreset_out_i_3_n_0 : STD_LOGIC;
  ...
  signal sm_reset_rx_pll_timer_sat_i_4_n_0 : STD_LOGIC;
  ...
  signal sm_reset_tx_pll_timer_sat_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_sm_reset_rx[2]_i_3\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of gtrxreset_out_i_3 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of gtwiz_reset_rx_datapath_int_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of gtwiz_reset_rx_done_int_i_2 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of gtwiz_reset_rx_pll_and_datapath_int_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \sm_reset_all_timer_ctr[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \sm_reset_all_timer_ctr[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of sm_reset_all_timer_sat_i_1 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of sm_reset_rx_pll_timer_sat_i_3 : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of sm_reset_rx_timer_sat_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of sm_reset_tx_pll_timer_clr_i_1 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of sm_reset_tx_pll_timer_sat_i_3 : label is "soft_lutpair15";
...
\FSM_sequential_sm_reset_rx[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\FSM_sequential_sm_reset_tx_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => gtwiz_reset_clk_freerun_in(0),
      CE => bit_synchronizer_gtwiz_reset_userclk_tx_active_inst_n_1,
      D => \sm_reset_tx__0\(0),
      Q => sm_reset_tx(0),
...
bit_synchronizer_gtwiz_reset_rx_datapath_dly_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_2
     port map (
      ...
      \FSM_sequential_sm_reset_rx_reg[0]_0\ => bit_synchronizer_plllock_rx_inst_n_3,
      Q(0) => sm_reset_rx(0),
      gtwiz_reset_clk_freerun_in(0) => gtwiz_reset_clk_freerun_in(0),
      gtwiz_reset_rx_pll_and_datapath_dly => gtwiz_reset_rx_pll_and_datapath_dly,
...
bit_synchronizer_gtwiz_reset_tx_pll_and_datapath_dly_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_5
     port map (
      ...
      \FSM_sequential_sm_reset_tx_reg[0]_0\ => sm_reset_tx_pll_timer_clr_reg_n_0,
      Q(2 downto 0) => sm_reset_tx(2 downto 0),
      gtwiz_reset_clk_freerun_in(0) => gtwiz_reset_clk_freerun_in(0),
      gtwiz_reset_tx_datapath_dly => gtwiz_reset_tx_datapath_dly,
      i_in_out_reg_0 => bit_synchronizer_gtwiz_reset_tx_pll_and_datapath_dly_inst_n_2,
...
bit_synchronizer_gtwiz_reset_userclk_rx_active_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_6
     port map (
      ...
      i_in_out_reg_0 => bit_synchronizer_gtwiz_reset_userclk_rx_active_inst_n_2,
...
bit_synchronizer_gtwiz_reset_userclk_tx_active_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_7
     port map (
      E(0) => bit_synchronizer_gtwiz_reset_userclk_tx_active_inst_n_1,
      \FSM_sequential_sm_reset_tx_reg[0]\ => bit_synchronizer_gtwiz_reset_userclk_tx_active_inst_n_0,
      \FSM_sequential_sm_reset_tx_reg[0]_0\ => \FSM_sequential_sm_reset_tx[2]_i_5_n_0\,
      \FSM_sequential_sm_reset_tx_reg[0]_1\ => bit_synchronizer_gtwiz_reset_tx_pll_and_datapath_dly_inst_n_2,
      \FSM_sequential_sm_reset_tx_reg[0]_2\ => bit_synchronizer_plllock_tx_inst_n_3,
      Q(2 downto 0) => sm_reset_tx(2 downto 0),
...
bit_synchronizer_plllock_rx_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_8
     port map (
      ...
      \FSM_sequential_sm_reset_rx_reg[0]_0\ => bit_synchronizer_plllock_rx_inst_n_2,
      \FSM_sequential_sm_reset_rx_reg[0]_1\ => sm_reset_rx_cdr_to_clr_i_3_n_0,
      \FSM_sequential_sm_reset_rx_reg[0]_2\ => bit_synchronizer_rxcdrlock_inst_n_3,
      ...
      sm_reset_rx_timer_clr_reg_0 => gtrxreset_out_i_3_n_0
    );
bit_synchronizer_plllock_tx_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_9
     port map (
      ...
      gtwiz_reset_tx_done_int_reg_2 => \FSM_sequential_sm_reset_tx[2]_i_5_n_0\,
...
bit_synchronizer_rxcdrlock_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_bit_synchronizer_10
     port map (
      ...
      gtwiz_reset_rx_any_sync => gtwiz_reset_rx_any_sync,
      gtwiz_reset_rx_cdr_stable_out(0) => gtwiz_reset_rx_cdr_stable_out(0),
      i_in_out_reg_0 => bit_synchronizer_rxcdrlock_inst_n_3,
      plllock_rx_sync => plllock_rx_sync,
      rxcdrlock_out(0) => rxcdrlock_out(0),
...
gtwiz_reset_rx_done_int_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
reset_synchronizer_gtwiz_reset_rx_any_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_reset_synchronizer_11
     port map (
      \FSM_sequential_sm_reset_rx_reg[0]\ => reset_synchronizer_gtwiz_reset_rx_any_inst_n_2,
      \FSM_sequential_sm_reset_rx_reg[1]\ => reset_synchronizer_gtwiz_reset_rx_any_inst_n_1,
      \FSM_sequential_sm_reset_rx_reg[2]\ => reset_synchronizer_gtwiz_reset_rx_any_inst_n_3,
      Q(2 downto 0) => sm_reset_rx(2 downto 0),
      ...
      \gen_gtwizard_gthe4.rxuserrdy_int\ => \^gen_gtwizard_gthe4.rxuserrdy_int\,
      gtrxreset_out_reg => gtrxreset_out_i_3_n_0,
      gtwiz_reset_clk_freerun_in(0) => gtwiz_reset_clk_freerun_in(0),
      gtwiz_reset_rx_any_sync => gtwiz_reset_rx_any_sync,
...
reset_synchronizer_gtwiz_reset_tx_any_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_reset_synchronizer_14
     port map (
      ...
      txuserrdy_out_reg => bit_synchronizer_gtwiz_reset_userclk_tx_active_inst_n_2
    );
...
\sm_reset_rx_cdr_to_ctr_reg[0]_i_2\: unisim.vcomponents.CARRY8
     port map (
      ...
      S(0) => \sm_reset_rx_cdr_to_ctr[0]_i_3_n_0\
    );
...
\sm_reset_rx_pll_timer_ctr[9]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
        ...
        port map (
      I0 => sm_reset_rx_pll_timer_sat_i_2_n_0,
...
sm_reset_rx_pll_timer_sat_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
        ...
        port map (
      I0 => sm_reset_rx_pll_timer_sat_i_3_n_0,
      I1 => sm_reset_rx_pll_timer_sat_i_4_n_0,
...
sm_reset_rx_pll_timer_sat_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
sm_reset_rx_pll_timer_sat_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      O => sm_reset_rx_pll_timer_sat_i_4_n_0
    );
...
sm_reset_tx_pll_timer_sat_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
        ...
        port map (
      I0 => sm_reset_tx_pll_timer_sat_i_3_n_0,
      I1 => sm_reset_tx_pll_timer_sat_i_4_n_0,
...
sm_reset_tx_pll_timer_sat_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
sm_reset_tx_pll_timer_sat_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      O => sm_reset_tx_pll_timer_sat_i_4_n_0
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_gthe4 is
  ...
  signal \gen_gtwizard_gthe4.gen_channel_container[25].gen_enabled_channel.gthe4_channel_wrapper_inst_n_8\ : STD_LOGIC;
  signal \gen_gtwizard_gthe4.gen_channel_container[25].gen_enabled_channel.gthe4_channel_wrapper_inst_n_94\ : STD_LOGIC;
...
\gen_gtwizard_gthe4.gen_channel_container[25].gen_enabled_channel.gthe4_channel_wrapper_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gthe4_channel_wrapper
     port map (
      ...
      \gen_gtwizard_gthe4.txprogdivreset_int\ => \gen_gtwizard_gthe4.txprogdivreset_int\,
      \gen_gtwizard_gthe4.txuserrdy_int\ => \gen_gtwizard_gthe4.txuserrdy_int\,
      \gthe4_channel_gen.gen_gthe4_channel_inst[0].GTHE4_CHANNEL_PRIM_INST\ => \gen_gtwizard_gthe4.gen_channel_container[25].gen_enabled_channel.gthe4_channel_wrapper_inst_n_94\,
      gthrxn_in(0) => gthrxn_in(0),
      gthrxp_in(0) => gthrxp_in(0),
      gthtxn_out(0) => gthtxn_out(0),
      gthtxp_out(0) => gthtxp_out(0),
      ...
      rxmcommaalignen_in(0) => rxmcommaalignen_in(0),
      rxoutclk_out(0) => rxoutclk_out(0),
      rxoutclkpcs_out(0) => \gen_gtwizard_gthe4.gen_channel_container[25].gen_enabled_channel.gthe4_channel_wrapper_inst_n_8\,
      rxpcommaalignen_in(0) => rxpcommaalignen_in(0),
      rxpmaresetdone_out(0) => rxpmaresetdone_out(0),
...
\gen_gtwizard_gthe4.gen_pwrgood_delay_inst[0].delay_powergood_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_v1_7_19_gthe4_delay_powergood
     port map (
      RXRATE(0) => \gen_gtwizard_gthe4.rxratemode_ch_int\,
      \gen_powergood_delay.intclk_rrst_n_r_reg[4]_0\ => \gen_gtwizard_gthe4.gen_channel_container[25].gen_enabled_channel.gthe4_channel_wrapper_inst_n_94\,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top is
  ...
  attribute C_RX_COMMA_M_ENABLE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is 1;
  ...
  attribute C_RX_COMMA_P_ENABLE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is 1;
  ...
  attribute C_RX_DATA_DECODING of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is 1;
  ...
  attribute C_RX_INT_DATA_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is 40;
  attribute C_RX_LINE_RATE : string;
  attribute C_RX_LINE_RATE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is "10.000000";
  ...
  attribute C_RX_OUTCLK_FREQUENCY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is "250.000000";
  ...
  attribute C_RX_USRCLK2_FREQUENCY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is "250.000000";
  attribute C_RX_USRCLK_FREQUENCY : string;
  attribute C_RX_USRCLK_FREQUENCY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is "250.000000";
  ...
  attribute C_TX_LINE_RATE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gtwizard_ultrascale_0_gtwizard_top : entity is "10.000000";
